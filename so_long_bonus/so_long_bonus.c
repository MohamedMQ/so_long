...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/04/08 11:10:19 by mmaqbour          #+#    #+#             */
/*   Updated: 2023/04/08 11:20:26 by mmaqbour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char *argv[])
{
	...
	mlx_loop_hook(data.data_2.mlx, move, &data);
	mlx_hook(data.w_n.mlx_win, 17, 0, close_window, &data);
	mlx_key_hook(data.w_n.mlx_win, ft_check_and_display, &data);
